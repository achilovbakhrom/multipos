...
public class MpLeftButton extends RelativeLayout {
    ...
    public MpLeftButton(Context context) {
        super(context);
        init(context, null);
    }

    public MpLeftButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MpLeftButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MpLeftButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        if (!isPressed) {
            setBackgroundResource(R.drawable.matrix_left_bg);
            imageView.setImageResource(R.drawable.ellipse_not_active);
            isPressed = false;
        } else {
            setBackgroundResource(R.drawable.matrix_left_pressed_bg);
